...
from services.overseer.upgrade_planer.app.service.upgrade_planer.upgrade_planer import UpgradePlaner, NO_DOWNGRADE, \
    ACCEPT_ALL
...
class TestUpgradePlaner(object):
    def test_update_catalog_new_service(self, event_payload, upgrade_planer: UpgradePlaner):
        ...
        new_version = {"version": "1.0.1", "dependencies": event_payload['scale_config']['dependencies']}
    ...
    def test_update_catalog_existing_version(self, event_payload, upgrade_planer: UpgradePlaner):
        upgrade_planer.mongo.catalog.find_one.return_value = {
            ...
            "service": event_payload['service'],
            "versions": {
                "1.0.1": {"version": "1.0.1", "dependencies": event_payload['scale_config']['dependencies']}
            },
        }
        upgrade_planer.on_new_version(event_payload)
...
class TestStepComputing(object):
    ...
    def test_build_steps(self, upgrade_planer: UpgradePlaner):
        goal = [[{"name": "producer", }, "1.0.17"], [{"name": "consumer",}, "1.0.17"]]
        upgrade_planer.mongo.catalog.find.return_value = [
    ...
    @pytest.mark.parametrize(('goal_param', 'current_state', 'compatible_phase', 'expected'), [
        (
        ...
        (
            ...
            {'a': "2", "b": "2", 'c': '2'},
            {"a": "1", "b": "1", "c": "1"},
            [{"a": "1", "b": "1", "c": "2"}, {"a": "1", "b": "2", "c": "2"}, {"a": "1", "b": "2", "c": "1"}],
            [('b', '1', '2'), ('c', '1', '2',), ('a', '1', '2')]
        )
    ])
...
class TestSolveBestPhase(object):
    ...
    def test_best_phase(self, upgrade_planer: UpgradePlaner):
        phases = [
            ...
            [[{"name": "producer", }, "1.0.17"], [{"name": "consumer", }, "1.0.17"]],
        ]
        upgrade_planer.mongo.catalog.find.return_value = [
            {"name": "producer", "versions": ["1.0.1", "1.0.16", "1.0.17"]},
            {"name": "consumer", "versions": ["1.0.1", "1.0.17"]}
        ]
        ...
        goal, rank = s
        assert 0 == rank
        assert goal == [[{"name": "producer", }, "1.0.17"], [{"name": "consumer", }, "1.0.17"]]
